package com.spark4862.easyimclient.client;

import com.spark4862.easyimclient.client.handler.NettyClientHandlerInitializer;
  ...
  public void start() throws InterruptedException {
    ...
    bootstrap.connect().addListener(new ChannelFutureListener() {
      ...
      public void operationComplete(ChannelFuture future) throws Exception {
        ...
        log.info("[start][Netty Client 连接服务器({}:{}) 成功, client启动在:{}]", serverHost, serverPort,
            ((SocketChannel) channel).localAddress().getPort());
      }
    });
  }
